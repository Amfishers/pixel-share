...
const video2Char = {
    ...
    initImg2Char () {
        this.charSize = document.getElementById('sizeValue') && document.getElementById('sizeValue').value || 4
        this.img2char = new Img2char(this.charSize)
    },
    getImage() {
        const {
            videoWidth: w,
        ...
        if (w) {
            ...
            this.preview.innerText = this.img2char.toChars(ctx, w, h)
        }
    },
    beginCapture() {
        this.endCapture()
